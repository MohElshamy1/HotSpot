...
# and gather the steady state temperatures onto a file. This is done by:
 ../../hotspot -c example.config -f Heterogenous.flp -p Heterogenous.ptrace -materials_file example.materials -model_type block -steady_file outputs/gcc.steady -o outputs/gcc.ttrace
...
../../hotspot -c example.config -init_file gcc.init -f Heterogenous.flp -p Heterogenous.ptrace -materials_file example.materials -model_type block -o outputs/gcc.ttrace
